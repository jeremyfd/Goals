...
class DeveloperPreview: ObservableObject {
    ...
    let goal = Goal(ownerUid: "123", partnerUid: "123", timestamp: Timestamp(), title: "Play the Piano", frequency: 5, description: "I want to play Lalaland", duration: 1, currentCount: 4)
}
